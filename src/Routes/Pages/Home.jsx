        ...
        <Col className='review-column ms-3 me-2'>
            ...
            <Carousel indicators={false} className="align-items-center" activeIndex={index} onSelect={handleSelect}>
                ...
                <Carousel.Item className="review-carousel text-center ps-sm-5 pe-sm-5">
                    <p className='mt-4 mb-5 p-5 review-carousel-text'>Food was great, customer service was prompt and very helpful when I had questions about the menu. Looking forward to watching the Buffalo Bills games this fall and winter here. Go Bills!</p>
                    <div className='d-flex justify-content-end me-5 '>
                    <p>-Philip F.</p>
                    </div>
