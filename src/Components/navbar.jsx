  ...
  return (
    ...
    <Navbar   className="p-3 mt-0 pt-0 py-0 d-flex"> 
      ...
      <Row className="nav-row d-flex justify-content-between">
          ...
          <Col xs={5} sm={4} md={3} lg={3} className="shueys-column">
            <img src={ShueysLogo} alt="Shueys Logo" className=" shueys-logo  mt-0 "/>  
          </Col>

          <Col xs={2} sm={1} className="d-none d-sm-block d-md-none mt-auto pb-2 text-center">
            <a href="https://www.facebook.com/shueysrestaurant/"><img src={FacebookLogo} alt="Facebook Logo" className=""/> </a>
          </Col>

          <Col md={6} lg={7} className="mt-auto mb-0 d-none d-md-block  bebas"> 
          ...
          <Col  md={2} lg={2} className="d-none d-md-block mt-auto pb-3 ">
            <a className="" href="https://www.facebook.com/shueysrestaurant/"><img src={FacebookLogo} alt="Facebook Logo" className=""/> </a>
          </Col>

          <Col xs={3} sm={4} md={4} className="mt-auto d-flex align-items-end  ms-4 d-sm-block d-md-none">
          <SlideMenu />
          </Col>
