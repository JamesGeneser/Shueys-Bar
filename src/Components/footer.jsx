...
<>
    <Container fluid className="footer-container">
        <Row className="">
            <Col xs={8} md={4} lg={2}>
                <img src={ShueysLogo} alt="Shueys Logo" className="image me-0"/>
            </Col>
            <Col className="d-flex flex-column justify-content-center mt-4 ps-0" xs={2} sm={4} md={3} lg={2}>
                <img className="mt-5 pt-5 facebook-logo-footer" src={FacebookLogo} alt="Facebook Logo"/>
                <p className="me-auto mt-4 mb-0">©2024</p>
                <p className="d-none d-sm-none d-md-block me-auto mb-0">Site Design by Madison Stahl</p>
                <p className="d-none d-sm-none d-md-block me-auto mt-0">Built by James Geneser</p>
            </Col>

       
            <Col className="d-none d-sm-none d-md-block d-flex justify-content-start ps-0 mt-5" md={4} lg={4} xl={4}>
            ...
            <Col className="d-none d-sm-none d-md-none d-lg-block mt-5" lg={2} >
                <p className="footer-heading">Location:</p>
                    <Row>
                        <Col>
                            <p className="footer-location-text mb-1">1158 Club Rd NE</p>
